...
export function PricePredictionBadge({
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-slate-900/80 p-4 space-y-3.5 shadow-xl backdrop-blur-md">
      ...
      <div className="grid grid-cols-2 gap-3 rounded-xl bg-white/5 p-3 border border-white/5">
        <div>
        ...
        <div>
          ...
          <p className={`text-base font-bold ${pct < 0 ? "text-emerald-400" : pct > 0 ? "text-rose-400" : "text-sky-300"}`}>
