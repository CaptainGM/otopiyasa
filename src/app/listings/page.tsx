          ...
          <section key={id} className="card space-y-4 p-5">
            <div className="flex flex-wrap items-start gap-4">
              <div className="flex flex-col items-center gap-1.5 shrink-0">
                <Link
                  href={`/cars/${id}`}
                  className="relative block h-24 w-36 overflow-hidden rounded-xl bg-[var(--bg-soft)] border border-white/10 hover:border-amber-400/40 transition"
                  title="İlan detay sayfasını aç"
                >
