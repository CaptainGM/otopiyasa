            ...
            child: ListTile(
              ...
              trailing: _api.isAdmin
                  ? Container(
                      ...
                      child: const Text('YÖNETİCİ', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: AppTheme.accent)),
                    )
                  : null,
            ),
          ),
          if (_api.isAdmin) ...[
            ...
            Card(
              ...
              child: ListTile(
                ...
                title: const Text('Yönetim Paneli & 7/24 Bot Takibi', style: TextStyle(fontWeight: FontWeight.bold, color: AppTheme.accent)),
                subtitle: const Text('Frankfurt VPS, canlı kalp atışı, ölü ilan temizliği ve onaylar', style: TextStyle(fontSize: 11, color: Colors.white70)),
                trailing: const Icon(Icons.arrow_forward_ios, size: 14, color: AppTheme.accent),
        ...
        children: [
          ...
          SizedBox(
            ...
            child: OutlinedButton.icon(
              onPressed: () => UpdateService.checkUpdate(context, manual: true),
