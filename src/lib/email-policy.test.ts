...
describe("canonicalEmail", () => {
  it("Gmail nokta ve +etiket hilelerini normalize eder", () => {
    const base = canonicalEmail("berat.batuhan@gmail.com");
    expect(canonicalEmail("beratbatuhan@gmail.com")).toBe(base);
    expect(canonicalEmail("berat.batuhan+test1@gmail.com")).toBe(base);
    expect(canonicalEmail("B.E.R.A.T.batuhan+x@GMAIL.com")).toBe(base);
  });
