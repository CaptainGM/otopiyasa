...
export default async function CarDetailPage({ params }: CarDetailPageProps) {
  ...
  await enrichArabamCarIfNeeded(carDoc);

  // Arşivdeki/silinmiş veya satılmış ilanları normal kullanıcılar için nazikçe karşıla
  ...
  // önbellekle aynı marka/model tekrar açılınca anında geliyor.
    ...
    cached(
      ...
      CACHE_TTL.medium,
      () => getSimilarCars(carDoc._id.toString(), brand, model, price, 4, carDoc.title)
    ),
